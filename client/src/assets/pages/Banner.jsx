        ...
        <div className='container position-relative'>
          ...
          <div className='slogan d-none d-md-block'>
            <div>
              ...
              <span>
                <img
                  src='/MERN-petslove/images/footprint.png'
                  alt='footprint'
                />
                The Best choose
              </span>
          ...
          <div>
            <img
              ...
              src='/MERN-petslove/images/bannerDogFrameOrange.png'
              alt=''
            />
            <img
              className='bannerDog position-absolute'
              src='/MERN-petslove/images/bannerDog.png'
              alt='bannerDog'
            />
            <img
          ...
          <div>
            <img
              ...
              src='/MERN-petslove/images/bannerCatFame.png'
              alt='bannerCatFrame'
            />
            <img
              className='bannerCat position-absolute'
              src='/MERN-petslove/images/bannercat.png'
              alt='bannercat'
            />
          </div>
          {/* <!-- footprint --> */}
